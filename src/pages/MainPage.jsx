...
const MainPage = () => {
  ...
  const [selectedComponent, setSelectedComponent] = useState(components[0]); // Initialize with the first component
  ...
  const handleSearch = (e) => {
    ...
    if (filteredComponent) {
      ...
      setSelectedComponent(null); // If no match is found, set to null
    }
  };
  ...
  const buttonStyle = {
    backgroundColor: isShining ? '#45a049' : '#f95738',
    color: 'white',
    padding: '15px 32px',
    textAlign: 'center',
    fontSize: '16px',
    ...
    boxShadow: isShining ? '0 0 15px 5px rgba(255, 255, 255, 0.7)' : 'none',
  };
        ...
        <div className="panes">
          <div className="left-pane">
            ...
            {SelectedComponent ? (
              ...
              <p>No Component Found. Try another search term.</p>
            )}
          </div>
